...
**Branch-aware technical guide for [`agent/security-axios-lock`](https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock)**
...
<p>
  <a href="https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Personal-Website/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Personal-Website/codespaces/new?ref=agent%2Fsecurity-axios-lock"><strong>Open in Codespaces</strong></a>
</p>
...
| Item | Detected value |
|---|---|
| Purpose | A legacy Gulp 4 personal website scaffold for Nischhal Raj Subba, currently based on a starter-kit structure with HTML/Pug, Sass/SCSS/Less/Stylus, Babel, BrowserSync, image optimization, and dist build output, intended to be evolved into a real personal portfolio or landing page. |
...
- [`README.md`](https://github.com/Nischhalsubba/Personal-Website/blob/agent/security-axios-lock/README.md)
...
```mermaid
flowchart TD
    ROOT["Personal-Website / agent/security-axios-lock"]
    ROOT --> P0[".github/"]
    ROOT --> P1["bin/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["src/"]
...
|---|---|
| Interface | [`src`](https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock/src) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock/.github) |
...
- [`.github/workflows/apply-interactive-readme.yml`](https://github.com/Nischhalsubba/Personal-Website/blob/agent/security-axios-lock/.github/workflows/apply-interactive-readme.yml)
...
| Branch | [`agent/security-axios-lock`](https://github.com/Nischhalsubba/Personal-Website/tree/agent/security-axios-lock) |
| Ownership | No CODEOWNERS file detected |
| Contributing | Use the contribution flow above |
| Support | [Open or review issues](https://github.com/Nischhalsubba/Personal-Website/issues) |
| License | [`LICENSE`](https://github.com/Nischhalsubba/Personal-Website/blob/agent/security-axios-lock/LICENSE) |
